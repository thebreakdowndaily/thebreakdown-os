...
export type MgnregaTracker = TrackerDefinition;

export const mgnregaTracker: TrackerDefinition = {
  id: 'mgnrega',
  slug: 'mgnrega',
  title: 'MGNREGA → VB-G RAM G Act 2025',
  subtitle: "India's rural employment guarantee — 20 years of MGNREGA, then the 2026 overhaul",
  description:
    'Track the legislative transition from MGNREGA 2005 (100 days) to the Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (125 days), including key data, evidence, and what changed.',
  ...
  evidenceChain: [
    {
      ...
      documentTitle: 'Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025',
    },
    {
    ...
    },
    {
      ...
      lastVerified: '2026-07-23',
      documentTitle: 'MoRD Annual Report 2025-26',
    },
    {
      ...
      documentTitle: 'CAG Performance Audit of MGNREGA',
    },
  ],
  timeSeries: [
    {
      id: 'mgnrega-budget-growth',
      title: 'Rural Employment Scheme Budget Allocation (2006–2027)',
      subtitle: 'Union budget allocation trends for rural employment safety net',
      unit: '₹ Crore',
      source: 'Union Budget Documents & MoRD Expenditure Accounts',
      frequency: 'Annual (Union Budget)',
      data: [
        { date: '2006-07', value: 11300, label: '₹11.3K Cr' },
        { date: '2011-12', value: 40000, label: '₹40.0K Cr' },
        { date: '2016-17', value: 47500, label: '₹47.5K Cr' },
        { date: '2020-21', value: 111500, label: '₹111.5K Cr' },
        { date: '2023-24', value: 86000, label: '₹86.0K Cr' },
        { date: '2025-26', value: 86000, label: '₹86.0K Cr' },
        { date: '2026-27', value: 105000, label: '₹105.0K Cr' },
      ],
    },
  ],
  documents: [
    {
      title: 'National Rural Employment Guarantee Act, 2005 (Act No. 42 of 2005)',
      type: 'act',
      date: '2005-09-07',
      publisher: 'Parliament of India',
      url: 'https://egazette.gov.in',
      summary: 'Original legislation guaranteeing 100 days of wage employment per household. Now repealed under Section 36(1) of Act No. 18 of 2025.',
      keyClauses: [
        'Section 3: Guarantee of rural wage employment up to 100 days.',
        'Section 7: Payment of unemployment allowance if work is not provided within 15 days.',
      ],
    },
    {
      title: 'Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025',
      type: 'act',
      date: '2025-12-18',
      publisher: 'Parliament of India',
      url: 'https://rural.gov.in',
      summary: 'Replacement legislation expanding the statutory guarantee to 125 days per household per financial year. Act No. 18 of 2025.',
      keyClauses: [
        'Section 4: Expanded guarantee of 125 days of wage employment.',
        'Section 36(1): Express repeal of Act No. 42 of 2005.',
        'Section 36(2): Transitional preservation of active job cards.',
      ],
    },
    {
      title: 'MoRD Notification S.O. 2415(E)',
      type: 'notification',
      date: '2026-06-15',
      publisher: 'Ministry of Rural Development',
      url: 'https://egazette.gov.in',
      summary: 'Commencement notification fixing 1 July 2026 as the date the 2025 Act comes into force nationwide.',
      keyClauses: [
        'Clause 1: Appoints the 1st day of July, 2026 as the date of commencement of Act No. 18 of 2025.',
      ],
    },
    {
      title: 'MoRD Annual Report 2025-26',
      type: 'report',
      date: '2026-05-01',
      publisher: 'Ministry of Rural Development',
      url: 'https://rural.gov.in',
      summary: 'Operational data including person-days, women participation (55.3%), expenditure, and state-wise coverage.',
    },
    {
      title: 'CAG Performance Audit of MGNREGA',
      type: 'audit',
      date: '2025-12-01',
      publisher: 'Comptroller & Auditor General of India',
      url: 'https://cag.gov.in',
      summary: 'Audit findings on wage delays, fund leakage, and incomplete social audits.',
    },
  ],
...
export function getMgnregaTracker(): TrackerDefinition {
  return mgnregaTracker;
}
