...
export const semiconductorTracker: TrackerDefinition = {
  ...
  documents: [
    { title: 'Union Cabinet Decision on ISM Guidelines (2021)', type: 'decision', date: '2021-12-15', summary: 'Cabinet approval for ₹76,000 crore incentive package for semiconductor and display manufacturing ecosystem.' },
    { title: 'India Semiconductor Mission (ISM) Guidelines', type: 'guideline', date: '2022-01-01', summary: 'Operational framework and fiscal support criteria (up to 50% capital subsidy) for Fabs, ATMP/OSAT, and Compound Semis.' },
    { title: 'Union Cabinet Approval of 5 Semiconductor Proposals (2025)', type: 'decision', date: '2025-03-15', summary: 'Approved project commitments for Tata Dholera Fab, Micron Sanand, CG Semi Sanand, Tata Morigaon, and Kaynes.' },
    { title: 'MeitY Commercial Production Notification Q1 2026', type: 'notification', date: '2026-02-15', summary: 'Official commencement record of packaged semiconductor output at CG Semi Sanand facility.' },
    { title: 'MeitY Annual Report 2025-26', type: 'report', date: '2026-05-01', summary: 'Annual progress tracking of electronics manufacturing, PLI disbursements, and semiconductor cluster infrastructure.' },
  ],
