...
export default function SourcesList({ sources }: SourcesListProps) {
  ...
  return (
    <section id="sources" aria-label="Sources" className="max-w-[900px] mx-auto px-4 sm:px-6 py-12 sm:py-16">
      <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F5] mb-6">Sources</h2>
          ...
          <div className="space-y-2">
            {items.map((src, i) => {
              ...
              return (
                ...
                >
                  <span className="text-sm font-medium text-[#A1A1AA] group-hover:text-[#F5F5F5] transition-colors">
                    {src.name}
                  </span>
