...
const GlobalWatch: React.FC<GlobalWatchProps> = ({ stories }) => {
  if (stories.length === 0) return null;

  return (
    <section aria-label="Global watch" className="py-8">
      <Container>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {stories.map((story) => (
          <a
            ...
            className="group bg-gray-800 border border-cyan-900/30 rounded-xl overflow-hidden hover:border-cyan-400/50 transition-colors"
          >
            {story.heroImage && (
            ...
            <div className="p-4">
              ...
              <h3 className="text-base font-semibold text-gray-100 group-hover:text-cyan-400 transition-colors mb-1 leading-snug">
                {story.headline}
              </h3>
