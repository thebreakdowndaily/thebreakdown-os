...
export const getKnowledgeLibrarySeedData = cache((): KnowledgeLibrary[] => {
  return [indiaAndTheWorld, indianEconomy];
});
...
const chapter1Blocks: KnowledgeBlock[] = [
  ...
  // Visual: British India — the empire that Partition dissolved
  ...
  // Visual: Mountbatten and Jinnah — the architects of Partition
  ...
  // Visual: the Radcliffe Line — a border drawn in five weeks
  ...
  // Visual: migration flows — the human geography of Partition
  ...
  // Visual: military balance — the arithmetic of national security
  ...
  // Visual: princely states — the accession map
  ...
  // Visual: Kashmir — the theatre of the first India-Pakistan war
  ...
  // Visual: the Instrument of Accession — the document that changed Kashmir's fate
  ...
  { id: 'b-h-document-archive', type: 'heading', data: { text: 'Document Archive', level: 1 } },
  {
    ...
    data: {
      ...
      linkedClaims: ['b-claim-trauma', 'b-claim-integration', 'b-claim-borders'],
  ...
  },
  {
    ...
    data: {
      ...
      linkedClaims: ['b-claim-kashmir', 'b-claim-un'],
  ...
  // positions above. This section contains supplementary assets, document facsimiles
  // referenced from the main text, and additional context maps and charts.
  { id: 'b-h-visual-archive', type: 'heading', data: { text: 'Visual Archive', level: 1 } },
  { id: 'b-vis-archive-note', type: 'callout', data: { variant: 'info', text: 'This archive contains the complete set of visual assets for Chapter 1. Key narrative visuals — maps, archival photographs, charts, and explanatory diagrams — are embedded at the point in the narrative where they best serve reader understanding. This section serves as a reference index for supplementary materials, document facsimiles, and additional context.' } },
  ...
  { id: 'b-vis-sup-01', type: 'image', data: { title: 'Muslim refugees fleeing India for Pakistan crowd train engine, 1947', caption: 'Muslim refugees fleeing India for Pakistan crowd the engine of a train departing from Delhi in 1947.', altText: 'Muslim refugees crowding a steam train engine at a Delhi station, 1947.', url: '/images/library/supplementary/partition/sup-01-muslim-refugees-train-engine-delhi-1947-daily-herald.jpg', provenance: { creator: 'Daily Herald Archive', source: 'National Science & Media Museum / SSPL via Getty Images', reference: '1360179719', date: '1947' }, license: 'Rights Managed', credit: 'Daily Herald Archive / Contributor via Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.refugee-crisis'], note: 'PROVISIONAL — SUP-01.' } },
  { id: 'b-vis-sup-02', type: 'image', data: { title: 'Muslims boarding special train at New Delhi Station for Pakistan, 7 August 1947', caption: 'Farewells are said as Muslims prepare to board the special train that will take them to Pakistan, New Delhi, 7 August 1947.', altText: 'Muslims boarding a train at New Delhi station, August 1947.', url: '/images/library/supplementary/partition/sup-02-muslims-boarding-train-new-delhi-1947-keystone.jpg', provenance: { creator: 'Keystone Features', source: 'Getty Images', reference: '3336843', date: '1947-08-07' }, license: 'Rights Managed', credit: 'Keystone Features / Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.refugee-crisis'], note: 'PROVISIONAL — SUP-02.' } },
  { id: 'b-vis-sup-03', type: 'image', data: { title: 'Gandhi and Nehru addressing refugees from the Punjab at Hardwar relief camp, June 1947', caption: 'Mahatma Gandhi and Jawaharlal Nehru addressing refugees from the Punjab at a relief camp in Hardwar, June 1947.', altText: 'Gandhi and Nehru speaking to refugees at a relief camp, 1947.', url: '/images/library/supplementary/gandhi/sup-03-gandhi-nehru-refugees-hardwar-1947.jpg', provenance: { creator: 'Universal History Archive', source: 'Getty Images', reference: '973199382', date: '1947-06' }, license: 'Rights Managed', credit: 'Universal History Archive / Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.gandhi-jinnah-talks', 'claim.partition.refugee-crisis'], note: 'PROVISIONAL — SUP-03.' } },
  { id: 'b-vis-sup-04', type: 'image', data: { title: 'Armed soldiers join Muslim refugees crowding a vehicle on trek to Pakistan, 5 September 1947', caption: 'Armed soldiers stand guard as Muslim refugees crowd onto a vehicle during the mass trek to Pakistan, September 1947.', altText: 'Soldiers and Muslim refugees on a vehicle, 1947.', url: '/images/library/supplementary/partition/sup-04-soldiers-refugees-vehicle-trek-1947-bettmann.jpg', provenance: { creator: 'Bettmann', source: 'Getty Images', reference: '515214340', date: '1947-09-05' }, license: 'Rights Managed', credit: 'Bettmann / Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.refugee-crisis'], note: 'PROVISIONAL — SUP-04.' } },
  { id: 'b-vis-sup-05', type: 'image', data: { title: 'Muslim refugees trekking on foot to Pakistan with belongings, September 1947', caption: 'Muslim refugees carrying their personal belongings and leading animals as they trek to Pakistan during the Partition migration, September 1947.', altText: 'Muslim refugees on foot with belongings trekking to Pakistan, 1947.', url: '/images/library/supplementary/partition/sup-05-refugees-trekking-foot-belongings-1947-bettmann.jpg', provenance: { creator: 'Bettmann', source: 'Getty Images', reference: '701041686', date: '1947-09-05' }, license: 'Rights Managed', credit: 'Bettmann / Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.refugee-crisis'], note: 'PROVISIONAL — SUP-05.' } },
  { id: 'b-vis-sup-06', type: 'image', data: { title: 'Aarzi Hukumat Junagadh volunteers arriving in Junagadh, 25 September 1947', caption: 'A train carrying \'Aarzi Hukumat Junagadh\' (Provisional Government of Junagadh) volunteers arrives in Junagadh, 25 September 1947.', altText: 'Volunteers arriving by train in Junagadh, September 1947.', url: '/images/library/supplementary/accession/sup-06-junagadh-volunteers-train-1947.jpg', provenance: { creator: 'Unknown', source: 'Getty Images', reference: '1971029537', date: '1947-09-25' }, license: 'Rights Managed', credit: 'Getty Images', status: 'archived', aiGenerated: false, linkedClaims: ['claim.partition.princely-states'], note: 'PROVISIONAL — SUP-06.' } },
  { id: 'b-vis-sup-07', type: 'image', data: { title: 'Mahatma Gandhi with Abha Gandhi and Kanu Gandhi', caption: 'Mahatma Gandhi with Abha Gandhi (right) and Kanu Gandhi (left).', altText: 'Gandhi with Abha Gandhi and Kanu Gandhi.', url: '/images/library/supplementary/gandhi/sup-07-gandhi-abha-kanu-gandhi.jpg', provenance: { creator: 'Unknown (possibly Kanu Gandhi or Ruhe/ullstein bild collection)', source: 'Unknown', reference: '1711791173', date: 'Unknown' }, license: 'Unknown', credit: 'Source unconfirmed', status: 'archived', aiGenerated: false, linkedClaims: [], note: 'PROVISIONAL — SUP-07. Unmapped.' } },
  // Maps
...
const indianEconomy: KnowledgeLibrary = {
  id: 'kl-2',
  slug: 'indian-economy',
  ...
  collections: [
    {
      id: 'kl-col-2',
      librarySlug: 'indian-economy',
      slug: 'economic-policy-2026',
      title: 'Economic Policy 2026',
      subtitle: 'The 2026 Transition',
      summary: 'Analysing the key economic reforms of 2026.',
      order: 1,
      dateRange: { start: '2020', end: '2026' },
      createdAt: '2026-07-23T00:00:00Z',
      updatedAt: '2026-07-23T00:00:00Z',
      volumes: [
        {
          ...
          subtitle: 'Policy Shifts and Outcomes',
          summary: 'Detailed accounts of major structural policy shifts in the Indian economy during 2026.',
          order: 1,
          dateRange: { start: '2025', end: '2026' },
          estimatedReadingTime: { explorer: 20, scholar: 60, researcher: 120 },
          createdAt: '2026-07-23T00:00:00Z',
          updatedAt: '2026-07-23T00:00:00Z',
          chapters: [
            {
              ...
              slug: 'mgnrega-reform',
              title: 'The MGNREGA Transition of 2026',
              summary: 'Analysis of the repeal of MGNREGA 2005 and its replacement by the Viksit Bharat Rozgar Act 2025, taking effect July 2026.',
              order: 1,
              difficulty: 2,
              version: { major: 1, minor: 0, patch: 0, label: 'verified' },
              metadata: { editor: 'The Breakdown Editorial', wordCount: 1500, sourceCount: 3 },
              readingTime: { explorer: 10, scholar: 30, researcher: 60 },
              studyTime: { explorer: 15, scholar: 45, researcher: 90 },
              content: [
                { id: 'b-mgnrega-1', type: 'paragraph', data: { text: 'The rural employment landscape was fundamentally altered in 2026 with the implementation of the new Rozgar Act.' } },
                { id: 'b-mgnrega-2', type: 'claim', data: { claimId: 'clm-mgnrega-reform-001', displayMode: 'inline' } },
                { id: 'b-mgnrega-3', type: 'claim', data: { claimId: 'clm-mgnrega-reform-002', displayMode: 'inline' } },
                { id: 'b-mgnrega-4', type: 'claim', data: { claimId: 'clm-mgnrega-reform-003', displayMode: 'inline' } },
                { id: 'b-mgnrega-5', type: 'claim', data: { claimId: 'clm-mgnrega-reform-004', displayMode: 'inline' } },
                { id: 'b-mgnrega-6', type: 'claim', data: { claimId: 'clm-mgnrega-reform-005', displayMode: 'inline' } },
              ],
              status: 'verified',
              lastVerifiedAt: '2026-07-23T17:50:45.409Z',
              createdAt: '2026-07-23T00:00:00Z',
              updatedAt: '2026-07-23T00:00:00Z',
              relatedEntityIds: ['ministry-of-rural-development'],
              relatedConceptIds: [],
              relatedSourceIds: ['src-mgnrega-reform-1', 'src-mgnrega-reform-2', 'src-mgnrega-reform-3'],
              prerequisites: [],
              learningObjectives: [],
              recommendedNext: [],
              keyQuestions: [],
            ...
            },
            {
              ...
              volumeSlug: 'structural-reforms',
              slug: 'rbi-repo-rate',
              title: 'RBI Monetary Policy Adjustments 2026',
              summary: 'Analysis of the Reserve Bank of India\'s decision to cut the repo rate after an extended pause from 2023 to 2024.',
              order: 2,
              difficulty: 3,
              version: { major: 1, minor: 0, patch: 0, label: 'verified' },
              metadata: { editor: 'The Breakdown Editorial', wordCount: 1500, sourceCount: 2 },
              readingTime: { explorer: 10, scholar: 30, researcher: 60 },
              studyTime: { explorer: 15, scholar: 45, researcher: 90 },
              content: [
                { id: 'b-rbi-1', type: 'paragraph', data: { text: 'The monetary policy environment eased significantly in mid-2026.' } },
                { id: 'b-rbi-2', type: 'claim', data: { claimId: 'clm-rbi-repo-rate-001', displayMode: 'inline' } },
                { id: 'b-rbi-3', type: 'claim', data: { claimId: 'clm-rbi-repo-rate-002', displayMode: 'inline' } },
                { id: 'b-rbi-4', type: 'claim', data: { claimId: 'clm-rbi-repo-rate-003', displayMode: 'inline' } },
                { id: 'b-rbi-5', type: 'claim', data: { claimId: 'clm-rbi-repo-rate-004', displayMode: 'inline' } },
              ],
              status: 'verified',
              lastVerifiedAt: '2026-07-23T17:50:45.409Z',
              createdAt: '2026-07-23T00:00:00Z',
              updatedAt: '2026-07-23T00:00:00Z',
              relatedEntityIds: ['rbi'],
              relatedConceptIds: [],
              relatedSourceIds: ['src-rbi-repo-rate-1', 'src-rbi-repo-rate-2'],
              prerequisites: [],
              learningObjectives: [],
              recommendedNext: [],
              keyQuestions: [],
