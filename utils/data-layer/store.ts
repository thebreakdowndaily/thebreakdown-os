...
function seed(): DataStore {
  ...
  const story1: APIStory = {
    ...
    keyPoints: [
      'MGNREGA 2005 completed 20 years of operation in 2026, delivering 100 days of guaranteed wage employment.',
      'Parliament enacted the Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (Act No. 18 of 2025) to replace MGNREGA 2005.',
      'Ministry of Rural Development notified S.O. 2415(E) fixing nation-wide commencement effective July 1, 2026.',
      'Statutory wage employment guarantee expanded from 100 days to 125 days per rural household per financial year under the 2025 Act.',
      'MGNREGA 2005 stood repealed under Section 36(1) of Act No. 18 of 2025 with full transitional protection for existing job card holders.',
    ],
    timeline: [
      { date: '2006-02-02', title: 'MGNREGA 2005 Enacted', description: 'Parliament passes the National Rural Employment Guarantee Act (Act No. 42 of 2005) guaranteeing 100 days of work.', source: 'PRS Legislative' },
      { date: '2008-04-01', title: 'Phase 1 Completion', description: 'Scheme covers 200 most backward districts nationwide.', source: 'MoRD' },
      ...
      { date: '2020-04-01', title: 'COVID-19 Relief Surge', description: 'Demand for work surges 40% during pandemic lockdowns.', source: 'MoRD Annual Report' },
      { date: '2026-02-02', title: '20th Anniversary Milestone', description: 'Cumulative historical expenditure exceeds ₹8 lakh crore over two decades.', source: 'The Breakdown Analysis' },
      { date: '2025-12-18', title: 'VB-G RAM G Act Enacted', description: 'Parliament passes the Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (Act No. 18 of 2025).', source: 'Gazette of India' },
      { date: '2026-06-15', title: 'Commencement Notification', description: 'MoRD issues Notification S.O. 2415(E) fixing July 1, 2026 as the date of nationwide commencement.', source: 'Ministry of Rural Development' },
      { date: '2026-07-01', title: 'What Changed on 1 July 2026?', description: 'VB-G RAM G Act 2025 comes into force; 125-day statutory guarantee operationalized; MGNREGA 2005 repealed under Sec 36(1).', source: 'The Breakdown Gazette Analysis' },
    ],
    facts: [
      { label: 'Statutory Guarantee (Current Law)', value: '125 days/year', source: 'VB-G RAM G Act 2025 (w.e.f. July 1, 2026)' },
      { label: 'Statutory Guarantee (Historical)', value: '100 days/year', source: 'MGNREGA 2005 (2005–2026)' },
      { label: 'Active Rural Workers', value: '14.2 crore', source: 'NREGA / VB-G RAM G MIS' },
      { label: 'Women Participation (2025-26)', value: '55.3%', source: 'MoRD Annual Report' },
    ],
    claims: [
      { claim: 'MGNREGA 2005 remains the active statutory law governing rural wage employment in India.', source: 'Public Statements', verification: 'misleading', explanation: 'MGNREGA 2005 was repealed under Section 36(1) of Act No. 18 of 2025. Effective July 1, 2026, the operative statute is the Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (VB-G RAM G Act, 2025).', confidence: 0.98 },
      { claim: 'The statutory guarantee for rural wage employment is 100 days per household.', source: 'Historical Manuals', verification: 'outdated', explanation: 'While 100 days was the statutory limit under MGNREGA 2005, the VB-G RAM G Act, 2025 expanded the statutory guarantee to 125 days per household per financial year starting 1 July 2026.', confidence: 0.96 },
    ],
    sources: [
      { name: 'Gazette of India Notification S.O. 2415(E) — VB-G RAM G Act 2025 Commencement', url: 'https://egazette.gov.in', type: 'government', tier: 1 },
      { name: 'Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (Act No. 18 of 2025)', url: 'https://rural.gov.in', type: 'government', tier: 1 },
      { name: 'Ministry of Rural Development Annual Report 2025-26', url: 'https://rural.gov.in', type: 'government', tier: 1 },
    ],
    charts: [
      { type: 'line', title: 'Rural Employment Budget Allocation Over Time (₹ Crore)', data: [
        { year: '2006-07', amount: 11300 }, { year: '2011-12', amount: 40000 },
        { year: '2016-17', amount: 47500 }, { year: '2020-21', amount: 111500 },
        { year: '2025-26', amount: 86000 }, { year: '2026-27 (Est)', amount: 105000 },
      ], xKey: 'year', yKey: 'amount' },
    ],
    faq: [
      { question: 'Who is eligible for work under the current rural employment law?', answer: 'Any adult rural household member willing to do unskilled manual work is eligible under the VB-G RAM G Act, 2025. All existing MGNREGA job cards remain valid during the transition.' },
      { question: 'What is the guaranteed number of days of employment?', answer: 'Under the historical 2005 Act, 100 days were guaranteed. Effective 1 July 2026, under the Viksit Bharat – Guarantee for Rozgar and Ajeevika Mission (Gramin) Act, 2025 (Act No. 18 of 2025), the statutory guarantee is expanded to 125 days of wage employment per rural household per financial year.' },
    ],
    relatedStories: [
    ...
    relatedEntities: [
      { id: 'ministry-of-rural-development', slug: 'ministry-of-rural-development', name: 'Ministry of Rural Development',image: '/images/entities/ministry-of-rural-development.jpg',  type: 'organization', description: 'Nodal ministry for rural employment schemes.' },
  ...
  const story4: APIStory = {
    ...
    headline: "India's Semiconductor Push: Program Outlay, Project Investment & Commercial OSAT Debut",
    summary: "With ₹76,000 crore in government program outlay and ₹1.26 lakh crore in approved project commitments across 5 units, India's semiconductor strategy reached a commercial milestone in Q1 2026 as the CG Semi OSAT facility in Sanand commenced commercial production, while the Tata-PSMC Dholera Fab remains under construction.",
    ...
    keyPoints: [
      'Programme Outlay: Government allocated ₹76,000 crore ($10B) fiscal incentive outlay for the India Semiconductor Mission.',
      'Approved Project Investment: ₹1,26,000 crore ($15.2B) cumulative private investment committed across 5 approved facilities.',
      'COMMERCIAL_PRODUCTION: CG Semi OSAT facility in Sanand commenced commercial chip packaging in Q1 2026.',
      'PILOT_PRODUCTION: Micron Sanand ATMP facility operational with commercial assembly ramp-up in H1 2026.',
      'UNDER_CONSTRUCTION: Tata-PSMC Dholera Fab (₹91,000 cr) and Tata Morigaon OSAT facility progressing cleanroom and civil works.',
    ],
    timeline: [
      { date: '2021-12-15', title: '₹76,000 Crore PLI Outlay Announced', description: 'Government approves ₹76,000 crore PLI scheme for semiconductor and display manufacturing.', source: 'PIB' },
      { date: '2024-06-10', title: 'Vedanta-Foxconn JV Scrapped', description: 'Joint venture dissolves; partners re-apply independently under revised ISM guidelines.', source: 'Company Statements' },
      { date: '2025-03-15', title: 'Union Cabinet Approves 5 Proposals', description: 'Cabinet approves ₹1.26 lakh crore total project investments across 5 semiconductor facilities in Gujarat and Assam.', source: 'Union Cabinet' },
      { date: '2026-02-15', title: 'COMMERCIAL_PRODUCTION: CG Semi OSAT', description: 'CG Semi OSAT facility in Sanand commences commercial chip packaging, marking India\'s first commercial OSAT production.', source: 'MeitY PIB Release Q1 2026' },
      { date: '2026-04-10', title: 'PILOT_PRODUCTION: Micron ATMP Sanand', description: 'Micron ATMP pilot line completes qualification runs; commercial volume ramp-up underway.', source: 'Micron Press Office' },
    ],
    facts: [
      { label: 'Government Programme Outlay', value: '₹76,000 crore ($10B)', source: 'Union Cabinet' },
      { label: 'Approved Project Commitments', value: '₹1.26 lakh crore ($15.2B)', source: 'ISM / MeitY' },
      { label: 'CG Semi Sanand Status', value: 'COMMERCIAL_PRODUCTION (Q1 2026)', source: 'MeitY' },
      { label: 'Micron Sanand Status', value: 'PILOT_PRODUCTION (H1 2026)', source: 'MeitY' },
      { label: 'Tata Dholera Fab Status', value: 'UNDER_CONSTRUCTION (Target 2027)', source: 'Tata Electronics' },
    ],
    claims: [
  ...
  const story6: APIStory = {
    id: 'rbi-repo-rate',
    slug: 'rbi-repo-rate',
    headline: 'RBI Repo Rate: Decoding Monetary Policy & Rate Easing Cycle',
    summary: 'Following a 125 bps easing cycle from the 6.50% peak pause of 2023–24 down to 5.25% in July 2026, India\'s monetary policy balances inflation control with growth support.',
    ...
    evidenceScore: 93,
    category: 'economy',
    tags: ['RBI', 'repo rate', '5.25%', 'monetary policy', 'MPC easing cycle', 'inflation', 'interest rates'],
    primaryEntityId: 'rbi',
    relatedTopicIds: ['economy'],
    keyPoints: [
      'Current policy repo rate stands at 5.25% as of July 2026 following a 125 bps cumulative rate easing cycle.',
      'Historical peak rate of 6.50% was maintained in pause stance throughout 2023–2024 before MPC initiated rate cuts in 2025.',
      'Verified RBI MPC Chronology: Feb 2023–Dec 2024 (6.50% Peak Pause) -> Feb 2025 (6.00%) -> Aug 2025 (5.50%) -> Feb 2026 (5.25%).',
      'Inflation targeting framework completed 10 years of operation with headline CPI staying within the 4% ±2% band.',
    ],
    timeline: [
      ...
      { date: '2023-02-08', title: 'Peak Pause Rate (6.50%)', description: 'MPC raises repo rate to 6.50% and maintains pause stance through December 2024.', source: 'RBI MPC Resolution' },
      { date: '2025-02-07', title: 'Easing Cycle Begins (6.00%)', description: 'MPC cuts repo rate by 50 bps to 6.00% as headline CPI moderates below target.', source: 'RBI MPC Resolution' },
      { date: '2025-08-08', title: 'Second Rate Cut (5.50%)', description: 'MPC cuts repo rate by 50 bps to 5.50% to stimulate private investment and industrial growth.', source: 'RBI MPC Resolution' },
      { date: '2026-02-06', title: 'Third Rate Cut (5.25%)', description: 'MPC reduces repo rate by 25 bps to 5.25%, maintaining stance through July 2026.', source: 'RBI MPC Resolution' },
    ],
    facts: [
      { label: 'Current Repo Rate (July 2026)', value: '5.25%', source: 'RBI MPC Resolution (June 2026)' },
      { label: 'Historical Peak Rate (2023-24)', value: '6.50%', source: 'RBI MPC Resolution (Feb 2023)' },
      { label: 'Standing Deposit Facility (SDF)', value: '5.00%', source: 'RBI Monetary Policy' },
      { label: 'Marginal Standing Facility (MSF)', value: '5.50%', source: 'RBI Monetary Policy' },
    ],
    claims: [
      { claim: 'The policy repo rate of the Reserve Bank of India is 6.50%.', source: 'Historical Articles', verification: 'outdated', explanation: '6.50% was the peak policy rate maintained during the 2023-2024 pause cycle. The RBI MPC subsequently lowered the repo rate to 5.25% by July 2026.', confidence: 0.98 },
    ...
    sources: [
      { name: 'RBI Monetary Policy Statement & MPC Resolutions 2025-2026', url: 'https://rbi.org.in', type: 'government', tier: 1 },
      { name: 'MPC Minutes Archive', url: 'https://rbi.org.in/mpc', type: 'government', tier: 1 },
    ],
    charts: [],
    faq: [
      { question: 'What is the current policy repo rate?', answer: 'As of July 2026, the RBI policy repo rate is 5.25%. This follows a 125 bps easing cycle (from the 6.50% peak pause maintained in 2023–24 down to 6.00% in Feb 2025, 5.50% in Aug 2025, and 5.25% in Feb 2026).' },
      { question: 'How does the repo rate affect common citizens?', answer: 'Repo rate changes affect loan EMIs, deposit interest rates, and overall economic growth. A lower repo rate reduces borrowing costs for home, auto, and commercial loans.' },
    ],
    relatedStories: [
      { slug: 'digital-payments-boom', headline: 'Digital Payments in Rural India: UPI\'s Unseen Revolution', summary: 'How UPI transformed rural financial inclusion.', publishedAt: '2026-06-12T08:00:00Z', readingTime: 8, evidenceScore: 88, category: 'technology' },
    ],
  ...
  const story8: APIStory = {
    ...
    heroImage: '/images/placeholders/education-placeholder.svg',
  ...
  const story9: APIStory = {
    ...
    headline: 'India\'s Groundwater Crisis: North-West Agricultural Belt Stressed as CGWB 2025 Assessment Tracks 449 BCM Recharge',
    summary: 'Groundwater depletion threatens India\'s food and water security. The CGWB 2025 National Compilation records 449.12 BCM annual recharge, 409.85 BCM extractable resource, and 240.15 BCM extraction (58.59% national extraction stage). Over-exploitation exceeds 100–150% in North-West agricultural districts (Punjab, Haryana, Rajasthan), while 1,118 of 6,738 assessment units (16.59%) nationwide are over-exploited.',
    ...
    evidenceScore: 92,
    category: 'environment',
    tags: ['groundwater', 'CGWB 2025', 'water crisis', '449 BCM recharge', 'agriculture', 'irrigation', 'water policy'],
    primaryEntityId: 'india',
    relatedTopicIds: ['environment', 'agriculture'],
    keyPoints: [
      'CGWB 2025 National Compilation reports total annual recharge of 449.12 BCM and total extraction of 240.15 BCM (58.59% national stage of extraction).',
      'Nationwide, 1,118 of 6,738 assessment units (16.59%) are categorized as over-exploited, with an additional 675 units (10.02%) critical.',
      'Over-exploitation is heavily concentrated in North-West agricultural belt districts (Punjab, Haryana, Rajasthan) where stage of extraction exceeds 100-150%.',
      'Agriculture accounts for 89% of total groundwater extraction nationwide, driven by power subsidies and water-intensive paddy-wheat crop cycles.',
    ],
    timeline: [
      ...
      { date: '2019-06-28', title: 'Chennai Water Crisis', description: 'Chennai runs out of water, with reservoirs drying up, highlighting the severity of urban-rural water stress.', source: 'News Reports' },
      ...
      { date: '2025-11-15', title: 'CGWB 2025 Assessment Released', description: 'CGWB releases National Compilation on Dynamic Ground Water Resources of India 2025, recording 449.12 BCM annual recharge and 58.59% extraction stage.', source: 'CGWB' },
    ],
    facts: [
      { label: 'Annual Groundwater Recharge (2025)', value: '449.12 BCM', source: 'CGWB 2025 Assessment' },
      { label: 'Annual Extractable Resource (2025)', value: '409.85 BCM', source: 'CGWB 2025 Assessment' },
      { label: 'Annual Groundwater Extraction (2025)', value: '240.15 BCM', source: 'CGWB 2025 Assessment' },
      { label: 'National Stage of Extraction', value: '58.59%', source: 'CGWB 2025 Assessment' },
      { label: 'Over-Exploited Assessment Units', value: '1,118 of 6,738 (16.59%)', source: 'CGWB 2025 Assessment' },
      { label: 'Agriculture Share of Extraction', value: '89%', source: 'CGWB 2025' },
    ],
    claims: [
      { claim: '62% of India\'s districts are over-exploited for groundwater nationwide.', source: 'Media Headlines', verification: 'misleading', explanation: 'The 62% figure overgeneralizes North-West agricultural districts (Punjab/Haryana/Rajasthan) to all 700+ national districts. CGWB 2025 data shows 1,118 out of 6,738 assessment units (16.59%) are over-exploited nationwide.', confidence: 0.95 },
      { claim: 'Annual groundwater recharge in India exceeds 445 BCM.', source: 'CGWB 2025 Report', verification: 'true', explanation: 'The CGWB 2025 National Compilation verifies total annual groundwater recharge at 449.12 BCM.', confidence: 0.96 },
    ],
    sources: [
      { name: 'CGWB National Compilation on Dynamic Ground Water Resources of India 2025', url: 'https://cgwb.gov.in', type: 'government', tier: 1 },
  ...
  const story10: APIStory = {
    ...
    primaryEntityId: 'ministry-of-consumer-affairs',
    ...
    charts: [
      { type: 'line', title: 'PDS Leakage Rate Over Time (%)', data: [
        { year: '2005', rate: 44 }, { year: '2010', rate: 40 },
        { year: '2015', rate: 35 }, { year: '2020', rate: 18 },
        { year: '2023', rate: 12 }, { year: '2025', rate: 9 },
      ], xKey: 'year', yKey: 'rate' },
      { type: 'bar', title: 'ONORC Portable Transactions (Crore)', data: [
        { year: '2020-21', amount: 2.1 }, { year: '2021-22', amount: 8.5 },
        { year: '2022-23', amount: 18.2 }, { year: '2023-24', amount: 32.6 },
        { year: '2024-25', amount: 44.3 }, { year: '2025-26', amount: 50.7 },
      ], xKey: 'year', yKey: 'amount' },
    ],
    faq: [
  ...
  const story28: APIStory = {
    ...
    claims: [
      { claim: 'The BJP secured 360+ seats in the 2024 Lok Sabha elections.', source: 'Campaign Slogans', verification: 'false', explanation: 'In the June 2024 general election, the BJP won 240 seats and the NDA coalition won 293 seats. 360+ was a campaign target, not an election outcome.', confidence: 0.99 },
      { claim: 'Passing constitutional amendments requiring a two-thirds majority is currently possible for the NDA alone.', source: 'Political Analysts', verification: 'misleading', explanation: 'With 293 NDA seats in the 543-member Lok Sabha, the ruling coalition is 69 seats short of the 362 votes needed for a two-thirds majority under Article 368.', confidence: 0.95 },
    ],
    sources: [
      { name: 'Election Commission of India — General Election 2024 Results', url: 'https://results.eci.gov.in', type: 'government', tier: 1 },
      { name: 'PRS Legislative — Constitution Amendment Process under Art. 368', url: 'https://prsindia.org', type: 'research', tier: 1 },
  ...
  const story31: APIStory = {
    ...
    heroImage: '/images/placeholders/health-placeholder.svg',
  ...
  const story39: APIStory = {
    id: 'india-china-border-lac',
    ...
    evidenceScore: 91,
    category: 'geopolitics',
    tags: ['India-China border', 'McMahon Line', 'Aksai Chin', 'LAC', 'Galwan', '1962 war', 'geopolitics', 'foreign policy', 'Tibet', 'territorial dispute'],
    primaryEntityId: 'india',
    relatedTopicIds: ['geopolitics', 'foreign-policy', 'security', 'history'],
    keyPoints: [
      'The India-China border dispute is three separate disputes — eastern (McMahon Line), middle (well-defined), and western (Aksai Chin)',
      'China built the Aksai Chin road (1954–1957) without India\'s knowledge, establishing de facto control over territory India claims',
      'The 1959 Tibetan uprising and Nehru\'s decision to grant asylum to the Dalai Lama caused irreversible deterioration in relations',
      'China\'s 1962 offensive was limited in aim — it withdrew to pre-war positions after "teaching India a lesson"',
      'The post-1962 "cold peace" system of confidence-building measures managed the dispute for five decades but did not resolve it',
      'Galwan Valley (2020) broke the norm against fatal clashes; both sides now deploy 100,000+ troops along the LAC',
    ],
    timeline: [
      { date: '1913-07-01', title: 'Simla Convention Convenes', description: 'Britain, Tibet, and China meet to define boundaries; the McMahon Line is proposed as the India-Tibet border.', source: 'Simla Convention (1914)' },
      { date: '1954-04-29', title: 'Panchsheel Agreement Signed', description: 'Sino-Indian Agreement on Tibet establishes Five Principles of Peaceful Coexistence; border question explicitly deferred.', source: 'Sino-Indian Agreement (1954)' },
      { date: '1957-01-01', title: 'China Builds Aksai Chin Road', description: 'China constructs a 1,200-km highway through disputed Aksai Chin territory without India\'s knowledge.', source: 'Indian intelligence reports' },
      { date: '1959-03-01', title: 'Tibetan Uprising', description: 'Tibetan rebellion against Chinese rule; Dalai Lama flees to India, permanently damaging India-China relations.', source: 'Nehru-Zhou correspondence' },
      { date: '1959-08-25', title: 'Longju Incident', description: 'First border clash — Chinese forces occupy Indian post in eastern sector; two Indian policemen killed.', source: 'MEA Annual Report 1959' },
      { date: '1960-04-20', title: 'Zhou Enlai Visits Delhi', description: 'Last major diplomatic effort before the war; no agreement reached despite officials-level talks.', source: 'Officials\' Report (1961)' },
      { date: '1961-11-02', title: 'India Adopts Forward Policy', description: 'India establishes military posts in disputed territory to assert sovereignty, provoking Chinese retaliation.', source: 'Maxwell (1970)' },
      { date: '1962-10-20', title: 'Sino-Indian War Begins', description: 'China launches coordinated offensive across eastern and western sectors during the Cuban Missile Crisis.', source: 'Henderson-Brooks Report' },
      { date: '1962-11-21', title: 'China Announces Unilateral Ceasefire', description: 'China withdraws to pre-war positions after achieving military objectives, leaving India\'s strategic assumptions in ruins.', source: 'Chinese MOFA statement' },
      { date: '1967-10-01', title: 'Nathu La and Cho La Clashes', description: 'Major border clashes at Sikkim tri-junction produce casualties on both sides but do not escalate to war.', source: 'Indian Army records' },
      { date: '1987-05-01', title: 'Sumdorong Chu Crisis', description: 'Border standoff in Arunachal Pradesh comes close to war; defused through diplomatic channels.', source: 'MEA records' },
      { date: '1988-12-19', title: 'Rajiv Gandhi Visits China', description: 'First Indian PM visit since Nehru; Joint Working Group on border question established.', source: 'MEA Annual Report 1988' },
      { date: '2017-06-16', title: 'Doklam Standoff', description: '73-day military standoff at India-China-Bhutan tri-junction; resolved through diplomatic de-escalation.', source: 'MEA statements' },
      { date: '2020-06-15', title: 'Galwan Valley Clashes', description: '20 Indian soldiers killed in hand-to-hand combat; first fatal border conflict since 1967.', source: 'MEA statements' },
    ],
    facts: [
      { label: 'Total Disputed Territory', value: '~125,000 sq km', source: 'Indian MEA' },
      { label: 'Chinese-controlled Territory India Claims', value: '~38,000 sq km (Aksai Chin)', source: 'Indian MEA' },
      { label: 'Indian-controlled Territory China Claims', value: '~90,000 sq km (Arunachal Pradesh)', source: 'Chinese MOFA' },
      { label: 'Indian Soldiers Killed (1962)', value: '1,383', source: 'Henderson-Brooks Report' },
      { label: 'Indian Soldiers Killed (Galwan 2020)', value: '20', source: 'Indian Army' },
      { label: 'Length of LAC', value: '3,488 km', source: 'Indian MEA' },
      { label: 'Troops Deployed (2024)', value: '100,000+ each side', source: 'Independent estimates' },
    ],
    claims: [
      { claim: 'The border dispute originates in competing territorial claims inherited from British colonial period.', source: 'Simla Convention', verification: 'verified', explanation: 'The McMahon Line (1914) was agreed between Britain and Tibet but China never accepted it.', confidence: 0.92 },
      { claim: 'China built a strategic road through Aksai Chin (1954–1957) without Indian knowledge.', source: 'Indian intelligence reports', verification: 'verified', explanation: 'Indian patrols discovered the road in 1958; diplomatic protest issued.', confidence: 0.95 },
      { claim: 'The 1959 Tibetan uprising caused irreversible deterioration in relations.', source: 'Nehru-Zhou correspondence', verification: 'verified', explanation: 'Nehru\'s granting of asylum to the Dalai Lama was seen as hostility by China.', confidence: 0.88 },
      { claim: 'China\'s 1962 offensive was limited in aim — not conquest, but to "teach India a lesson."', source: 'Maxwell (1970)', verification: 'verified', explanation: 'China withdrew unilaterally to pre-war positions after its military victory.', confidence: 0.85 },
      { claim: 'India\'s 1962 defeat was caused by military unpreparedness and faulty strategy.', source: 'Henderson-Brooks Report', verification: 'verified', explanation: 'Forward Policy scattered forces into isolated positions; logistics and equipment were inadequate.', confidence: 0.9 },
      { claim: 'The post-1962 "cold peace" is maintained through agreements that manage but do not resolve the dispute.', source: '1993, 1996, 2013 agreements', verification: 'verified', explanation: 'CBMs have reduced crisis frequency but the territorial claims remain irreconcilable.', confidence: 0.9 },
      { claim: 'Galwan (2020) was the first fatal conflict since 1967 and represents structural escalation.', source: 'MEA/independent estimates', verification: 'verified', explanation: 'Both sides now deploy 100,000+ troops; old model of managed conflict is no longer sufficient.', confidence: 0.92 },
    ],
    sources: [
      { name: 'Simla Convention (1914)', url: 'https://en.wikipedia.org/wiki/Simla_Convention', type: 'reference', tier: 2 },
      { name: 'Sino-Indian Agreement on Tibet (1954)', url: 'https://en.wikipedia.org/wiki/Panchsheel', type: 'reference', tier: 2 },
      { name: 'Nehru-Zhou Enlai Correspondence (1959–1962)', url: 'https://en.wikipedia.org/wiki/Nehru-Zhou_correspondence', type: 'reference', tier: 2 },
      { name: 'Report of the Officials (1961)', url: 'https://en.wikipedia.org/wiki/Sino-Indian_War', type: 'reference', tier: 2 },
      { name: 'Neville Maxwell, India\'s China War (1970)', url: 'https://en.wikipedia.org/wiki/India%27s_China_War', type: 'reference', tier: 2 },
      { name: 'Steven Hoffman, War and Peace in the Borderlands (2021)', url: '', type: 'reference', tier: 2 },
    ],
    charts: [
      { type: 'line', title: 'India-China Border Crises Timeline', data: [
        { year: '1962', event: 'Full-scale war' }, { year: '1967', event: 'Nathu La clashes' },
        { year: '1987', event: 'Sumdorong Chu' }, { year: '2013', event: 'Depsang' },
        { year: '2017', event: 'Doklam' }, { year: '2020', event: 'Galwan' },
      ], xKey: 'year', yKey: 'event' },
    ],
    faq: [
      { question: 'What is the Line of Actual Control (LAC)?', answer: 'The LAC is the de facto border between India and China established after the 1962 war. It is not legally agreed or marked on official maps — it is simply where both armies stopped. It runs approximately 3,488 km from Ladakh to Arunachal Pradesh.' },
      { question: 'What is the McMahon Line?', answer: 'The McMahon Line is the boundary between India and Tibet (now China) agreed at the 1914 Simla Convention between Britain and Tibet. China rejects it as a colonial imposition and argues Tibet lacked treaty-making capacity.' },
      { question: 'Why did China withdraw in 1962 after winning?', answer: 'Two explanations: strategic (China demonstrated dominance without provoking wider war) and logistical (Chinese supply lines were overstretched). The evidence supports both.' },
      { question: 'Has the border dispute killed anyone since 1962?', answer: 'Yes. The Galwan Valley clashes in June 2020 killed 20 Indian soldiers and an unconfirmed number of Chinese soldiers — the first fatal conflict since 1967.' },
    ],
    relatedStories: [
    ...
    relatedEntities: [
      { id: 'india', slug: 'india', name: 'India', type: 'country', description: 'Republic of India.' },
      { id: 'china', slug: 'china', name: 'China', type: 'country', description: 'People\'s Republic of China.' },
      { id: 'jawaharlal-nehru', slug: 'jawaharlal-nehru', name: 'Jawaharlal Nehru', type: 'person', description: 'First Prime Minister of India.' },
    ],
  };

  const story40: APIStory = {
    id: 'kashmir-the-first-test',
    ...
    evidenceScore: 89,
    category: 'geopolitics',
    tags: ['Kashmir', '1947 war', 'India-Pakistan', 'Accession', 'UN', 'plebiscite', 'Line of Control', 'geopolitics', 'Sheikh Abdullah', 'princely states'],
    primaryEntityId: 'india',
    relatedTopicIds: ['geopolitics', 'history', 'security', 'conflict'],
    keyPoints: [
      'Kashmir\'s Muslim-majority population with a Hindu ruler made the partition accession framework unworkable',
      'The tribal invasion of October 1947 was not spontaneous — it was planned and supported by Pakistan\'s leadership',
      'Maharaja Hari Singh signed the Instrument of Accession under extreme military pressure on 26 October 1947',
      'India\'s airlift of troops to Srinagar within 24 hours of accession prevented the fall of the Valley',
      'India\'s referral of the dispute to the UN in January 1948 internationalised the conflict and created a permanent diplomatic liability',
      'The ceasefire line established in January 1949 became today\'s Line of Control — a division that has never been settled by the people of Kashmir',
    ],
    timeline: [
      { date: '1947-08-15', title: 'Kashmir Remains Independent at Partition', description: 'Maharaja Hari Singh has not acceded to either India or Pakistan; hopes to maintain independence or negotiate from neutrality.', source: 'Schofield (2003)' },
      { date: '1947-08-12', title: 'Standstill Agreement Proposed', description: 'Maharaja proposes Standstill Agreements with both dominions; Pakistan accepts, India does not respond definitively.', source: 'Jha (1996)' },
      { date: '1947-10-12', title: 'Nehru-Liaquat Meeting in Lahore', description: 'Final diplomatic attempt fails; both sides begin preparing for the possibility of conflict.', source: 'Raghavan (2010)' },
      { date: '1947-10-22', title: 'Tribal Invasion Begins', description: 'Approximately 5,000–6,000 Pashtun tribal fighters with Pakistani support cross into Kashmir.', source: 'Lamb (1989)' },
      { date: '1947-10-24', title: 'Azad Kashmir Government Declared', description: 'Pro-Pakistan government declared in Muzaffarabad as tribal forces advance toward Srinagar.', source: 'Schofield (2003)' },
      { date: '1947-10-26', title: 'Instrument of Accession Signed', description: 'Maharaja signs Instrument of Accession to India under military pressure; India accepts with condition of plebiscite.', source: 'White Paper on Indian States' },
      { date: '1947-10-27', title: 'Indian Troops Airlifted to Srinagar', description: 'Indian Air Force airlifts troops and supplies to Srinagar within 24 hours of accession, preventing the Valley\'s fall.', source: 'Official History of the Indian Armed Forces' },
      { date: '1947-11-01', title: 'Battle of Shalateng', description: 'Indian forces defeat tribal forces outside Srinagar in the decisive battle of the war, securing the Kashmir Valley.', source: 'Raghavan (2010)' },
      { date: '1948-01-01', title: 'India Refers Kashmir to UN', description: 'India invokes Article 35 of the UN Charter, referring the dispute to the Security Council.', source: 'UNSC Records' },
      { date: '1948-04-21', title: 'UNSC Resolution 47', description: 'Security Council calls for ceasefire, demilitarisation, and a plebiscite under international supervision.', source: 'UNSC Resolution 47' },
      { date: '1948-05-01', title: 'Pakistani Army Enters the Conflict', description: 'Regular Pakistani Army troops enter Kashmir, changing the military balance.', source: 'Raghavan (2010)' },
      { date: '1948-11-01', title: 'Battle of Zoji La', description: 'Indian forces capture Zoji La pass in one of the war\'s most remarkable military operations.', source: 'Official History' },
      { date: '1949-01-01', title: 'UN Ceasefire Takes Effect', description: 'Ceasefire line established dividing Kashmir; India holds two-thirds, Pakistan one-third.', source: 'UN Commission Report' },
    ],
    facts: [
      { label: 'Kashmir Muslim Population (1947)', value: '77%', source: 'Census 1941' },
      { label: 'Tribal Invasion Force', value: '~5,000–6,000 fighters', source: 'Lamb (1989)' },
      { label: 'Indian Forces Airlifted to Srinagar', value: 'First battalion landed within 24 hours', source: 'Official History' },
      { label: 'Territory Held by India after Ceasefire', value: '~65%', source: 'UNCIP Report' },
      { label: 'Territory Held by Pakistan', value: '~35%', source: 'UNCIP Report' },
      { label: 'UN Resolutions on Kashmir', value: '10+ (1948–1951)', source: 'UN Digital Library' },
      { label: 'Current Line of Control Length', value: '~725 km', source: 'Indian MEA' },
    ],
    claims: [
      { claim: 'The partition framework left princely states to choose their allegiance, but Kashmir\'s unique demography made this framework unworkable.', source: 'Jha (1996); Lamb (1989)', verification: 'verified', explanation: 'Muslim-majority (77%), Hindu ruler, strategic geography bordering both dominions.', confidence: 0.92 },
      { claim: 'The tribal invasion of October 1947 was not spontaneous but was planned and supported by Pakistan\'s leadership.', source: 'Lamb (1989); Jha (1996)', verification: 'verified', explanation: 'Logistical coordination, arms supply, and Pakistani military personnel accompanied tribal fighters.', confidence: 0.88 },
      { claim: 'Maharaja Hari Singh signed the Instrument of Accession under extreme military pressure.', source: 'V.P. Menon; Jha (1996)', verification: 'verified', explanation: 'Tribal forces were ~50 miles from Srinagar; the Maharaja had lost control of his state.', confidence: 0.85 },
      { claim: 'India\'s airlift of troops to Srinagar on 27 October 1947 prevented the fall of the Kashmir Valley.', source: 'Official History; Raghavan (2010)', verification: 'verified', explanation: 'Tribal forces were approaching Srinagar; without the airlift the Valley would have fallen.', confidence: 0.9 },
      { claim: 'India\'s referral of Kashmir to the UN Security Council was a strategic error.', source: 'Raghavan (2010)', verification: 'verified', explanation: 'Nehru later said referring Kashmir to the UN was a mistake; it internationalised the conflict.', confidence: 0.82 },
      { claim: 'The ceasefire line established in January 1949 became a permanent division that has never been settled.', source: 'UNCIP Report; Schofield (2003)', verification: 'verified', explanation: 'The ceasefire line became the Line of Control — a division rejected by the people of Kashmir.', confidence: 0.9 },
    ],
    sources: [
      { name: 'Srinath Raghavan, War and Peace in Modern India (2010)', url: '', type: 'reference', tier: 1 },
      { name: 'Prem Shankar Jha, Kashmir 1947: Rival Versions of History (1996)', url: '', type: 'reference', tier: 1 },
      { name: 'Alastair Lamb, Incomplete Partition (1989)', url: '', type: 'reference', tier: 1 },
      { name: 'Victoria Schofield, Kashmir in Conflict (2003)', url: '', type: 'reference', tier: 1 },
      { name: 'Instrument of Accession (26 October 1947)', url: '', type: 'reference', tier: 2 },
      { name: 'UNSC Resolutions on Kashmir (1948–1951)', url: 'https://undocs.org', type: 'reference', tier: 2 },
    ],
    charts: [
      { type: 'bar', title: 'Kashmir Territorial Division After 1949 Ceasefire', data: [
        { entity: 'India', percent: 65 }, { entity: 'Pakistan', percent: 35 },
      ], xKey: 'entity', yKey: 'percent' },
    ],
    faq: [
      { question: 'What was the Instrument of Accession?', answer: 'The legal document by which Maharaja Hari Singh acceded Jammu and Kashmir to India on 26 October 1947. It restricted accession to defence, foreign affairs, and communications. India accepted it with the condition that the people of Kashmir would confirm it through a plebiscite.' },
      { question: 'Why did India take Kashmir to the UN?', answer: 'India referred the dispute to the UN Security Council under Article 35 on 1 January 1948, seeking to condemn Pakistani aggression. Nehru later called this a strategic error — it transformed a bilateral conflict into an international dispute and gave Pakistan a diplomatic platform.' },
      { question: 'What did UN Resolution 47 say?', answer: 'Passed on 21 April 1948, it called for a ceasefire, the withdrawal of Pakistani tribesmen and Pakistani troops, the reduction of Indian forces to minimum levels, and a UN-supervised plebiscite.' },
      { question: 'Did the UN plebiscite ever happen?', answer: 'No. India insisted on Pakistan\'s withdrawal first; Pakistan insisted on the plebiscite first. India later argued that conditions had changed (Pakistan\'s failure to withdraw, Pakistan\'s alignment with US military pacts invalidated the original terms).' },
    ],
    relatedStories: [
  ...
  stories.set(story39.slug, story39);
  stories.set(story40.slug, story40);
