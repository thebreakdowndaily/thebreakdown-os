...
module.exports = {
  test: {
    ...
    include: [
      ...
      'tests/chapter-rendering.test.ts',
      ...
      'tests/newsroom-intelligence.test.ts',
      'tests/newsroom-os.test.ts',
      'tests/newsroom-remediation.test.ts',
      'tests/newsroom-pib-adapter.test.ts',
      'tests/newsroom-pib-coverage.test.ts',
      'tests/newsroom-pib-recovery.test.ts',
      'tests/supabase-concurrency.test.ts',
      'tests/newsroom-concurrency-idempotency.test.ts',
      'tests/news-intelligence-benchmark-integrity.test.ts',
      'tests/news-intelligence-benchmark-v1.1-integrity.test.ts',
      'tests/news-intelligence-benchmark-v1.2-integrity.test.ts',
      'tests/newsroom-scorecard.test.ts',
      'tests/vs5-intelligence-decision-support.test.ts',
