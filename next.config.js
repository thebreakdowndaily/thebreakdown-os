...
const nextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://thebreakdown.in https://www.googletagmanager.com https://www.google-analytics.com https://static.cloudflareinsights.com https://*.ingest.sentry.io",
